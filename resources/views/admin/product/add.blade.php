              ...
              {!! Form::open(['url'=> route('product.store'), 'method' => 'POST', 'files'=>'true']) !!}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    {!! Form::textarea('description', null, ['class'=>'form-control', 'placeholder'=>'Product Description', 'required']) !!}
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    {!! Form::text('quantity', null, ['class'=>'form-control', 'placeholder'=>'Product Quantity', 'required']) !!}
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    {!! Form::text('sell_price', null, ['class'=>'form-control', 'placeholder'=>'Sell Price', 'required']) !!}
                  </div>
                   <div class="form-group">
                    {!! Form::label('size', 'Size') !!}
                    {!! Form::text('pack_size', null, ['class'=>'form-control', 'placeholder'=>'Pack Size', 'required']) !!}
                  </div>
                  <div class="form-group">
                    {!! Form::label('brand', 'Brand') !!}
                    {!! Form::select('brand_id',$brand , null, ['class'=>'form-control', 'placeholder'=>'Select brand', 'required']) !!}
                  </div>
                  <div class="form-group">
...
<script type="text/javascript">
    $(function() {
        nav_highlight("product-main", "product", "product-add");
